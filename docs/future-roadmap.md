...
**Objective:** Demonstrate an end-to-end, credible growth analysis workflow that can run locally or as a public web product.
...
- English / Chinese UI and report localization with browser persistence.
- Visible synthetic-data, causal-inference, and experiment-sizing limitations.

### Phase 1 Exit Criteria

- The full sample flow runs without external credentials.
- Core rules have deterministic tests.
- Type checking, linting, and the production build pass.
- The workflow can be explained clearly from data to decision to experiment in a short product demonstration.
...
- Use a structured output schema for diagnosis explanations, strategy narratives, experiment wording, and reports.
...
- **Content subscription platform:** Content discovery, consumption depth, creator or category affinity, trial conversion, and renewal.
